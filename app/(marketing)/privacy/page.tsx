...
export const metadata: Metadata = {
  ...
  description: "Learn how Herald protects your privacy with client-side encryption, on-chain storage, and zero PII exposure.",
};
    ...
    <div className="max-w-[700px] mx-auto px-6 py-16">
      <div className="mb-12">
        ...
        <p className="text-base text-text-muted leading-[1.7] max-w-[540px]">
          Herald was designed from the ground up to ensure your email address is
          never exposed to Herald&rsquo;s servers, notification protocols, or
          any third party.
        </p>
      </div>
